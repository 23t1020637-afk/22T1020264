...
using SV22T1020264.Models.Sales;
...
namespace SV22T1020264.BusinessLayers
{
    ...
    public static class SalesDataService
    {
        ...
        //TODO: CHECK FULL SOLUTION SALEDATASERVER
        ...
        /// <summary>
        /// lấy toàn bộ đơn hàng từ khách hàng
        /// </summary>
        /// <param name="customerId"></param>
        /// <returns></returns>
        public static async Task<List<Order>> ListOrderCustomerAsyncs(int customerId)
        {
            return await orderDB.ListOrderCustomerAsync(customerId);
        }
        /// <summary>
