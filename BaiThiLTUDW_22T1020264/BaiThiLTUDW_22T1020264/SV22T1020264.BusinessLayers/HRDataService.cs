using SV22T1020264.DataLayers.Interfaces;
using SV22T1020264.DataLayers.SQLServer;
using SV22T1020264.Models.Common;
using SV22T1020264.Models.HR;
using SV22T1020264.BusinessLayers;
using SV22T1020264.DataLayers.Interfaces;
using SV22T1020264.DataLayers.SQLServer;
using SV22T1020264.Models.Common;
using SV22T1020264.Models.HR;

namespace SV22T1020264.BusinessLayers
{
    /// <summary>
    ...
    public static class HRDataService
    {
        ...
        /// <returns></returns>
        public static async Task<bool> UpdateEmployeeRolesAsync(int employeeID, string role)
        {
            return await employeeDB.UpdateRoleAsync(employeeID, role);
        }
        public static async Task<string> GetEmployeeRoleAsync(int employeeID)
        {
            return await employeeDB.GetRoleAsync(employeeID);
        }
        /// <summary>
